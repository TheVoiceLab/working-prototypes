...
if __name__ == "__main__":
    ...
    ckpt = f"{MODEL_DIR}/diffusion_epoch_30.pth"
    if os.path.exists(ckpt):
        ...
        with torch.no_grad():
            labels = torch.full((64,), 7, dtype=torch.long).to(DEVICE)
            x = torch.randn(64, 1, IMG_SIZE, IMG_SIZE).to(DEVICE)
            ...
            vutils.save_image(x, "test_generated_7.png", normalize=True)
            print("✅ Generated digit '7' from loaded model")